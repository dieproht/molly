...
/** Molly's counterpart to
  * [[https://mongodb.github.io/mongo-java-driver/5.8/apidocs/driver-sync/com/mongodb/client/MongoClient.html MongoClient]].
  */
final case class MollySyncClient[F[_]] private (private[core] val delegate: MongoClient)(using f: Async[F]):

    /** [[https://mongodb.github.io/mongo-java-driver/5.8/apidocs/driver-sync/com/mongodb/client/MongoClient.html#getDatabase(java.lang.String)]]
      */
