...
/** Molly's counterpart to
  * [[https://mongodb.github.io/mongo-java-driver/5.8/apidocs/driver-reactive-streams/com/mongodb/reactivestreams/client/MongoDatabase.html MongoDatabase]]
  */
final case class MollyDatabase[F[_]] private[core] (private[core] val delegate: MongoDatabase)(using f: Async[F]):

    /** [[https://mongodb.github.io/mongo-java-driver/5.8/apidocs/driver-reactive-streams/com/mongodb/reactivestreams/client/MongoDatabase.html#getCollection(java.lang.String)]]
      */
    ...
    /** [[https://mongodb.github.io/mongo-java-driver/5.8/apidocs/driver-reactive-streams/com/mongodb/reactivestreams/client/MongoDatabase.html#listCollectionNames()]]
      */
    def listCollectionNames(): F[List[String]] = fromStreamPublisher(delegate.listCollectionNames(), 1).compile.toList

    /** [[https://mongodb.github.io/mongo-java-driver/5.8/apidocs/driver-reactive-streams/com/mongodb/reactivestreams/client/MongoDatabase.html#getReadConcern()]]
      */
    def getReadConcern(): ReadConcern = delegate.getReadConcern()

    /** [[https://mongodb.github.io/mongo-java-driver/5.8/apidocs/driver-reactive-streams/com/mongodb/reactivestreams/client/MongoDatabase.html#getReadPreference()]]
      */
    def getReadPreference(): ReadPreference = delegate.getReadPreference()

    /** [[https://mongodb.github.io/mongo-java-driver/5.8/apidocs/driver-reactive-streams/com/mongodb/reactivestreams/client/MongoDatabase.html#getWriteConcern()]]
      */
    def getWriteConcern(): WriteConcern = delegate.getWriteConcern()

    /** [[https://mongodb.github.io/mongo-java-driver/5.8/apidocs/driver-reactive-streams/com/mongodb/reactivestreams/client/MongoDatabase.html#withReadConcern(com.mongodb.ReadConcern)]]
      */
    def withReadConcern(readConcern: ReadConcern): MollyDatabase[F] =
        MollyDatabase(delegate.withReadConcern(readConcern))

    /** [[https://mongodb.github.io/mongo-java-driver/5.8/apidocs/driver-reactive-streams/com/mongodb/reactivestreams/client/MongoDatabase.html#withReadPreference(com.mongodb.ReadPreference]]
      */
    ...
    /** [[https://mongodb.github.io/mongo-java-driver/5.8/apidocs/driver-reactive-streams/com/mongodb/reactivestreams/client/MongoDatabase.html#withWriteConcern(com.mongodb.WriteConcern)]]
      */
